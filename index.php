...
$APPLICATION->SetTitle('АТБ Электроника');
?>
            ...
            <ul class="hm-cat--ul__MENU __C-SCRL LEFT">
                <li class="hm-cat--li__MENU_ITEM __C-SCRL DOWN">
                    <button class="hm-cat--button__MENU_ITEM">
                        <div class="hm-cat--div__MENU_ITEM">
                            <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/menu/Вычислительные-системы.png" alt="Вычислительные-системы">
                        </div>
                ...
                <li class="hm-cat--li__MENU_ITEM __C-SCRL DOWN">
                    <button class="hm-cat--button__MENU_ITEM">
                        ...
                        <svg class="hm-cat--svg__MENU_ITEM" width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="hm-cat--li__MENU_ITEM __C-SCRL DOWN">
                    <button class="hm-cat--button__MENU_ITEM">
                        <div class="hm-cat--div__MENU_ITEM">
                            <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/menu/Промышленный-интернет-вещей.png" alt="Промышленный-интернет-вещей">
                        </div>
                        <span class="hm-cat--span__MENU_ITEM">
                ...
                <li class="hm-cat--li__MENU_ITEM __C-SCRL DOWN">
                    <button class="hm-cat--button__MENU_ITEM">
                        <div class="hm-cat--div__MENU_ITEM">
                            <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/menu/Контроль-и-мониторинг.png" alt="Контроль и мониторинг">
                        </div>
                        <span class="hm-cat--span__MENU_ITEM">
                ...
                <li class="hm-cat--li__MENU_ITEM __C-SCRL DOWN">
                    <button class="hm-cat--button__MENU_ITEM">
                        <div class="hm-cat--div__MENU_ITEM">
                            <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/menu/Аппаратные-платформы.png" alt="Аппаратные-платформы">
                        </div>
                        <span class="hm-cat--span__MENU_ITEM">
                ...
                <li class="hm-cat--li__MENU_ITEM __C-SCRL DOWN">
                    <button class="hm-cat--button__MENU_ITEM">
                        <div class="hm-cat--div__MENU_ITEM">
                            <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/menu/Промышленные-компьютеры.png" alt="Промышленные-компьютеры">
                        </div>
                        <span class="hm-cat--span__MENU_ITEM">
                ...
                <li class="hm-cat--li__MENU_ITEM __C-SCRL DOWN">
                    <button class="hm-cat--button__MENU_ITEM">
                        <div class="hm-cat--div__MENU_ITEM">
                            <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/menu/Программое-обеспечение.png" alt="Программое-обеспечение">
                        </div>
                        <span class="hm-cat--span__MENU_ITEM">
                    ...
                    <article class="hm-cat--article__CARD __C-SCRL DOWN" href="#">
                        <div class="hm-cat--div__CARD_IMAGE">
                                ...
                                <div class="hm-cat--div__SWIPER_WRAPPER swiper-wrapper">
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3588J-SMC/АТБ-RK3588J-SMC_1.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3588J-SMC/АТБ-RK3588J-SMC_2.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3588J-SMC/АТБ-RK3588J-SMC_3.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3588J-SMC/АТБ-RK3588J-SMC_4.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3588J-SMC/АТБ-RK3588J-SMC_5.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="hm-cat--div__CARD_BTNS">
                                <button class="hm-cat--button__CARD_COMPARISON">
                                    <svg class="hm-cat--svg__CARD_COMPARISON" width="23" height="28" viewBox="0 0 23 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <button class="hm-cat--button__CARD_FAVOURITES">
                                    <svg class="hm-cat--svg__CARD_FAVOURITES" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a class="hm-cat--a__CARD" href="#">
                            ...
                            <svg width="28" height="22" viewBox="0 0 28 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0.166992 11H27.667M27.667 11L17.167 0.5M27.667 11L17.167 21.5" stroke="#C82121" stroke-width="0.25"/>
                            </svg>
                        </a>
                    </article>
                        ...
                        <div class="hm-cat--div__CARD_IMAGE">
                            <div class="hm-cat--div__SWIPER swiper">
                                <div class="hm-cat--div__SWIPER_WRAPPER swiper-wrapper">
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-2100/АТБ-2100_1.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-2100/АТБ-2100_2.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-2100/АТБ-2100_3.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-2100/АТБ-2100_4.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-2100/АТБ-2100_5.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-2100/АТБ-2100_6.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                </div>
                                <div class="hm-cat--div__SWIPER_PAGINATION swiper-pagination"></div>
                        ...
                        <div class="hm-cat--div__CARD_IMAGE">
                            <div class="hm-cat--div__SWIPER swiper">
                                <div class="hm-cat--div__SWIPER_WRAPPER swiper-wrapper">
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3568-MPC-G/АТБ-RK3568-MPC-G_1.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3568-MPC-G/АТБ-RK3568-MPC-G_2.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3568-MPC-G/АТБ-RK3568-MPC-G_3.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3568-MPC-G/АТБ-RK3568-MPC-G_4.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3568-MPC-G/АТБ-RK3568-MPC-G_5.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                </div>
                                <div class="hm-cat--div__SWIPER_PAGINATION swiper-pagination"></div>
                        ...
                        <div class="hm-cat--div__CARD_IMAGE">
                            <div class="hm-cat--div__SWIPER swiper">
                                <div class="hm-cat--div__SWIPER_WRAPPER swiper-wrapper">
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-2400/АТБ-2400_1.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-2400/АТБ-2400_2.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-2400/АТБ-2400_3.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-2400/АТБ-2400_4.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                </div>
                                <div class="hm-cat--div__SWIPER_PAGINATION swiper-pagination"></div>
                        ...
                        <div class="hm-cat--div__CARD_IMAGE">
                            <div class="hm-cat--div__SWIPER swiper">
                                <div class="hm-cat--div__SWIPER_WRAPPER swiper-wrapper">
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3568-MPC-M/АТБ-RK3568-MPC-M_1.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3568-MPC-M/АТБ-RK3568-MPC-M_2.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3568-MPC-M/АТБ-RK3568-MPC-M_3.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3568-MPC-M/АТБ-RK3568-MPC-M_4.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                </div>
                                <div class="hm-cat--div__SWIPER_PAGINATION swiper-pagination"></div>
                        ...
                        <div class="hm-cat--div__CARD_IMAGE">
                            <div class="hm-cat--div__SWIPER swiper">
                                <div class="hm-cat--div__SWIPER_WRAPPER swiper-wrapper">
                                    ...
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/ATB-RK3588J-SMC/АТБ-RK3588J-SMC_5.webp" alt="товар" loading="lazy">
                                        </div>
                                    </div>
                                </div>
                                <div class="hm-cat--div__SWIPER_PAGINATION swiper-pagination"></div>
...
<section class="hm-ind">
    <div class="hm-ind--div__CONT C-CONTAINER">
        <div class="c-common--div__HEAD hm-ind--div__HEAD" role="button">
            ...
            <svg class="hm-ind--svg__SUBMENU" width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="с-common--div__SECT_CONTENT hm-ind--div__CONTENT">
                    ...
                    <div class="hm-ind--div__CARD_IMAGE">
                        <a class="hm-ind--a__MORE" href="#">
                            ...
                            <svg width="27" height="20" viewBox="0 0 27 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 10H26M26 10L16.0727 1M26 10L16.0727 19" stroke="white" stroke-width="0.55"/>
                            </svg>
                        </a>
                        <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/hm-ind_1.png" alt="Отрасли 1" loading="lazy">
                    </div>
                </article>
                ...
                <article class="hm-ind--article__CARD __C-SCRL DOWN">
                    ...
                    <div class="hm-ind--div__CARD_IMAGE">
                        ...
                        <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/hm-ind_2.png" alt="Отрасли 2" loading="lazy">
                    </div>
                </article>
                ...
                <article class="hm-ind--article__CARD __C-SCRL DOWN">
                    ...
                    <div class="hm-ind--div__CARD_IMAGE">
                        ...
                        <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/hm-ind_3.png" alt="Отрасли 3" loading="lazy">
                    </div>
                </article>
            </div>
        </div>
...
<section class="hm-des">
    <div class="hm-des--div__CONT C-CONTAINER">
        <div class="c-common--div__HEAD hm-des--div__HEAD" role="button">
            ...
            <svg class="hm-des--svg__SUBMENU" width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 1L14 13.2353L27 1" stroke="#0C0C0C" stroke-width="0.25"></path>
            </svg>
        </div>
            ...
            <div class="с-common--div__SECT_CONTENT hm-des--div__CONTENT">
                <article class="hm-des--article__CARD __C-SCRL DOWN">
                    ...
                    <div class="hm-des--div__CARD_IMAGE">
                        ...
                        <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/hm-des_1.png" alt="Решение 1" loading="lazy">
                    </div>
                </article>
                ...
                <article class="hm-des--article__CARD __C-SCRL DOWN">
                    ...
                    <div class="hm-des--div__CARD_IMAGE">
                        ...
                        <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/hm-des_2.png" alt="Решение 2" loading="lazy">
                    </div>
                </article>
                ...
                <article class="hm-des--article__CARD __C-SCRL DOWN">
                    ...
                    <div class="hm-des--div__CARD_IMAGE">
                        ...
                        <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/hm-des_3.png" alt="Решение 3" loading="lazy">
                    </div>
                </article>
            </div>
        </div>
            ...
            <ul class="hm-hst--ul__MENU __C-SCRL LEFT">
                <li class="hm-hst--li__MENU_ITEM">
                    <button class="hm-hst--button__MENU_ITEM">
                        ...
                        <svg class="hm-hst--svg__MENU_ITEM" width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 1L14 13.2353L27 1" stroke="#0C0C0C" stroke-width="0.25"/>
                        </svg>
                    </button>
                ...
                <div class="hm-hst--div__CONTENT">
                    <article class="hm-hst--article__CARD __C-SCRL DOWN">
                        ...
                        <div class="hm-hst--div__CARD_IMAGE">
                            ...
                            <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/hm-hst_1.png" alt="Истории успеха 1" loading="lazy">
                        </div>
                    </article>
                    ...
                    <article class="hm-hst--article__CARD __C-SCRL DOWN">
                        ...
                        <div class="hm-hst--div__CARD_IMAGE">
                            ...
                            <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/hm-hst_2.png" alt="Истории успеха 2" loading="lazy">
                        </div>
                    </article>
                </div>
            </div>
        ...
        <div class="hm-pre--div__BODY">
            <form class="hm-pre--form__SUBMENU __C-SCRL DOWN"  action="#" method="" name="">
                <label class="hm-pre--label__SUBMENU1">
                    ...
                    <svg class="hm-pre--svg__SUBMENU" width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 1L14 13.2353L27 1" stroke="#0C0C0C" stroke-width="0.25"/>
                    </svg>
                </label>
            ...
            <div class="hm-pre--div__CONTENT">
                <article class="hm-pre--article__CARD __C-SCRL DOWN">
                    ...
                    <div class="hm-pre--div__CARD_IMAGE">
                        <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/hm-pre_1.png" alt="Пресс-центр 1" loading="lazy">
                    </div>
                ...
                <article class="hm-pre--article__CARD __C-SCRL DOWN">
                    <a class="hm-pre--a__CARD" href="#"></a>
                    <div class="hm-pre--div__CARD_IMAGE">
                        <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/hm-pre_2.png" alt="Пресс-центр 2" loading="lazy">
                    </div>
                    <a class="hm-pre--a__CARD_TAG1" href="#">
                        Новости
                    </a>
                ...
                <article class="hm-pre--article__CARD __C-SCRL DOWN">
                    <a class="hm-pre--a__CARD" href="#"></a>
                    <div class="hm-pre--div__CARD_IMAGE">
                        <img src="<?=SITE_TEMPLATE_PATH?>/assets/images/home/hm-pre_3.png" alt="Пресс-центр 3" loading="lazy">
                    </div>
                    <a class="hm-pre--a__CARD_TAG1" href="#">
                        Мероприятия
                    </a>
