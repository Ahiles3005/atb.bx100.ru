...
window.addEventListener ("load", function () {
    ...
    const openFrmCmrs = document.querySelector ("._OPEN_FRM._FORM_COMMERCIAL");
    

    // 1.1 Открытие

    
    openFrmCmrs?.addEventListener ("click", () => {
    ...
    const openFrmComm = document.querySelector ("._OPEN_FRM._FORM_COMMON");
    

    // 1.1 Открытие

    
    openFrmComm?.addEventListener ("click", () => {
    ...
    const openFrmReg = document.querySelector ("._OPEN_FRM._FORM_REGISTRATION");
    

    // 1.1 Открытие

    
    openFrmReg?.addEventListener ("click", () => {
    ...
    const openFrmVac = document.querySelector ("._OPEN_FRM._FORM_VACANCY");
    

    // 1.1 Открытие

    
    openFrmVac?.addEventListener ("click", () => {
    ...
    const openFrmSub = document.querySelector ("._OPEN_FRM._FORM_SUBSCR");
    

    // 1.1 Открытие

    
    openFrmSub?.addEventListener ("click", () => {
