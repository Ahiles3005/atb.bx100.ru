...
<form id="hrx-vac--form__FILTER" class="hrx-vac--form__FILTER" action="<? echo $arResult["FORM_ACTION"] ?>"
                    ...
                    <div class="hrx-vac--div__SELECT">
                        <? foreach ($arItem["LIST"] as $kList => $list): ?>
                            ...
                            <label class="hrx-vac--label__SELECT _TYPE">
                                <?= $list ?>
                                <input class="hrx-vac--input__SELECT _TYPE" type="radio" name="hrx-type"
                                       value="<?= $kList ?>">
                            </label>
                        <? endforeach ?>
                    </div>
                        ...
                        <div class="hrx-vac--div__SELECT">
                            <? foreach ($arItem["LIST"] as $kList => $list): ?>
                                ...
                                <label class="hrx-vac--label__SELECT _LOC">
                                    <?= $list ?>
                                    <input class="hrx-vac--input__SELECT _LOC" type="radio" name="hrx-loc"
                                           value="<?= $kList ?>">
                                </label>
                            <? endforeach ?>
                        </div>
                    ...
                    <div class="hrx-vac--div__SELECT">
                        <? foreach ($arItem["LIST"] as $kList => $list): ?>
                            ...
                            <label class="hrx-vac--label__SELECT _TIMING">
                                <?= $list ?>
                                <input class="hrx-vac--input__SELECT _TIMING" type="radio" name="hrx-timing"
                                       value="<?= $kList ?>">
                            </label>
                        <? endforeach ?>
                    </div>
    ...
    <div class="hrx-vac--div__FILTER_BOTTOM">
        <button class="hrx-vac--button__FILTER_BOTTOM __C-SCRL DOWN" type="submit">
        ...
        <button class="hrx-vac--button__FILTER_RESET __C-SCRL DOWN" type="reset">
