...
<?php
$isEmptyPREI_TEXT_1 = empty($arResult["DISPLAY_PROPERTIES"]['PREI_TEXT_1']['~VALUE']['TEXT']);
$isEmptyPREI_TEXT_2 = empty($arResult["DISPLAY_PROPERTIES"]['PREI_TEXT_2']['~VALUE']['TEXT']);
$isEmptyELEMENTY_PREIM = empty($arResult["PROPERTIES"]['ELEMENTY_PREIM']['DATA']);

?>
<? if (!$isEmptyPREI_TEXT_1 || !$isEmptyPREI_TEXT_2 || !$isEmptyELEMENTY_PREIM): ?>
    <section class="in-adv">
        <div class="in-adv--div__CONT C-CONTAINER">
            ...
            <? if (!$isEmptyPREI_TEXT_1 || !$isEmptyPREI_TEXT_2): ?>
                <div class="in-adv--div__TEXT">
                    <? if (!$isEmptyPREI_TEXT_1): ?>
                        <p class="st-main--p__DESCR1 __C-SCRL DOWN">
                            <?= $arResult["DISPLAY_PROPERTIES"]['PREI_TEXT_1']['~VALUE']['TEXT'] ?>
                        </p>
                    <? endif ?>
                    <? if (!$isEmptyPREI_TEXT_2): ?>
                        <p class="st-main--p__DESCR2 __C-SCRL DOWN">

                            <?= $arResult["DISPLAY_PROPERTIES"]['PREI_TEXT_2']['~VALUE']['TEXT'] ?>
                        </p>
                    <? endif ?>
                </div>
            <? endif ?>

            <? if (!$isEmptyELEMENTY_PREIM): ?>
...
<?php
$isEmptyTASK_TEXT_1 = empty($arResult["DISPLAY_PROPERTIES"]['TASK_TEXT_1']['~VALUE']['TEXT']);
$isEmptyTASK_TEXT_2 = empty($arResult["DISPLAY_PROPERTIES"]['TASK_TEXT_2']['~VALUE']['TEXT']);
$isEmptyTASK_TEXT_3 = empty($arResult["DISPLAY_PROPERTIES"]['TASK_TEXT_3']['~VALUE']['TEXT']);
$isEmptyTASK_TEXT_4 = empty($arResult["DISPLAY_PROPERTIES"]['TASK_TEXT_4']['~VALUE']['TEXT']);
?>

<? if (!$isEmptyTASK_TEXT_1 || !$isEmptyTASK_TEXT_2 || !$isEmptyTASK_TEXT_3 || !$isEmptyTASK_TEXT_4): ?>
