                            ...
                            <div class="cd-hero--div__IMAGES_TOP">
                                ...
                                <div class="cd-hero--div__CARD_BTNS">
                                    <button class="cd-hero--button__CARD_COMPARISON">
                                        <svg class="cd-hero--svg__CARD_COMPARISON" width="23" height="28" viewBox="0 0 23 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="cd-hero--div__POPUP_BODY">
                    ...
                    <div class="cd-hero--div__POPUP_MAIN">
                        <button class="cd-hero--button__POPUP_CLOSE">
                            <svg class="cd-hero--svg__POPUP_CLOSE" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect y="18.55" width="26.1834" height="2" rx="1" transform="rotate(-45 0 18.55)" fill="#005792"/>
                                <rect width="26.1834" height="2" rx="1" transform="matrix(-0.707107 -0.707107 -0.707107 0.707107 20 18.55)" fill="#005792"/>
                            </svg>
                        </button>
                        <div class="cd-hero--div__SWIPER swiper">
                            <div class="cd-hero--div__SWIPER_WRAPPER swiper-wrapper">
                                <div class="cd-hero--div__SWIPER_SLIDE swiper-slide">
                                    <img class="cd-hero--img__SWIPER_IMAGE" src="images/home/ATB-2100/АТБ-2100_1.webp" alt="" loading="lazy">
                                </div>
                                <div class="cd-hero--div__SWIPER_SLIDE swiper-slide">
                                    <img class="cd-hero--img__SWIPER_IMAGE" src="images/home/ATB-2100/АТБ-2100_2.webp" alt="" loading="lazy">
                                </div>
                                <div class="cd-hero--div__SWIPER_SLIDE swiper-slide">
                                    <img class="cd-hero--img__SWIPER_IMAGE" src="images/home/ATB-2100/АТБ-2100_3.webp" alt="" loading="lazy">
                                </div>
                                <div class="cd-hero--div__SWIPER_SLIDE swiper-slide">
                                    <img class="cd-hero--img__SWIPER_IMAGE" src="images/home/ATB-2100/АТБ-2100_4.webp" alt="" loading="lazy">
                                </div>
                                <div class="cd-hero--div__SWIPER_SLIDE swiper-slide">
                                    <img class="cd-hero--img__SWIPER_IMAGE" src="images/home/ATB-2100/АТБ-2100_5.webp" alt="" loading="lazy">
                                </div>
                                <div class="cd-hero--div__SWIPER_SLIDE swiper-slide">
                                    <img class="cd-hero--img__SWIPER_IMAGE" src="images/home/ATB-2100/АТБ-2100_6.webp" alt="" loading="lazy">
                                </div>
                                <div class="cd-hero--div__SWIPER_SLIDE swiper-slide">
                                    <img class="cd-hero--img__SWIPER_IMAGE" src="images/home/ATB-2100/АТБ-2100_3.webp" alt="" loading="lazy">
                                </div>
                        ...
                        <button class="cd-hero--button__POPUP_MORE">
                            ...
                            <svg width="20" height="25" viewBox="0 0 20 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10 0L10 24M10 24L19 14.8364M10 24L1 14.8364" stroke="#005792" stroke-width="0.5"/>
                            </svg>
                        </button>
                        <button class="cd-hero--button__POPUP_LESS">
                            <span class="cd-hero--span__POPUP_LESS">Показать меньше</span>
                            <svg width="20" height="25" viewBox="0 0 20 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10 25L10 1M10 1L19 10.1636M10 1L1 10.1636" stroke="#005792" stroke-width="0.5"/>
                            </svg>
                        </button>
                    </div>
                        ...
                        <div class="cd-hero--div__POPUP_CONTROL_SLIDE">
                            <button class="cd-hero--button__PREV">
                                <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7 1L1 7.46154L7 13" stroke="#0C0C0C" stroke-width="0.25" stroke-linecap="round"/>
                                </svg>
                            </button>
                            <button class="cd-hero--button__NEXT">
                                <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 1L7 7.46154L1 13" stroke="#0C0C0C" stroke-width="0.25" stroke-linecap="round"/>
                                </svg>
                            </button>
                        </div>
                        ...
                        <div class="cd-hero--div__POPUP_CONTROL_ZOOM">
                            <button class="cd-hero--button__PLUS">
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <line x1="0.125" y1="6.875" x2="13.875" y2="6.875" stroke="#0C0C0C" stroke-width="0.25" stroke-linecap="round"/>
                                    <line x1="6.875" y1="13.875" x2="6.875" y2="0.125" stroke="#0C0C0C" stroke-width="0.25" stroke-linecap="round"/>
                                </svg>
                            </button>
                            <button class="cd-hero--button__MINUS">
                                <svg width="14" height="1" viewBox="0 0 14 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <line x1="0.125" y1="0.875" x2="13.875" y2="0.875" stroke="#0C0C0C" stroke-width="0.25" stroke-linecap="round"/>
                                </svg>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="cd-abt--div__SWIPER2_SLIDE1_4">
                        ...
                        <ul class="cd-abt--ul__SWIPER2_SLIDE1_4_1">
                            <li class="cd-abt--li__SWIPER2_SLIDE1_4_1">
                                <svg class="cd-abt--svg__CORNER" width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.29289 2.40703C8.92286 1.77707 8.47669 0.699922 7.58579 0.699922L0.999999 0.699922C0.447714 0.699922 -5.36129e-07 1.14764 -5.60271e-07 1.69992L-8.48144e-07 8.28571C-8.87087e-07 9.17661 1.07714 9.62278 1.70711 8.99281L8.29289 2.40703Z" fill="#62BE37"/>
                                </svg>
                    ...
                    <div class="cd-abt--div__TABLE">
                        <div class="cd-abt--div__TABLE1">
                            <button class="cd-abt--button__TABLE_HEAD">
                                ...
                                <svg class="cd-abt--svg__TABLE_HEAD" width="28" height="13" viewBox="0 0 28 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="cd-abt--div__SWIPER3_NAV">
                            <button class="cd-abt--button__SWIPER3_PREV">
                                <svg width="12" height="22" viewBox="0 0 12 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.2002 1.65002L10.0002 11L1.2002 20.35" stroke="#C82121" stroke-width="1.5" stroke-linecap="round"/>
                                </svg>
                            </button>
...
<section class="cd-mat">
    <div class="cd-mat--div__CONT C-CONTAINER">
        <div class="c-common--div__HEAD cd-mat--div__HEAD" role="button">
            ...
            <svg class="cd-mat--svg__SUBMENU" width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="cd-reg--div__TABLE __C-SCRL DOWN">
            ...
            <a class="cd-reg--a__TABLE_GISP" href="#">
                ...
                <svg width="29" height="23" viewBox="0 0 29 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0.5 11.3457H28M28 11.3457L17.5 0.845703M28 11.3457L17.5 21.8457" stroke="#005792" stroke-width="0.5"/>
                </svg>
            </a>
    ...
    <div class="cd-rec--div__CONT C-CONTAINER">
        ...
        <div class="cd-rec--div__SWIPER swiper __C-SCRL DOWN">
                                ...
                                <div class="hm-cat--div__SWIPER_WRAPPER swiper-wrapper">
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="images/home/ATB-RK3588J-SMC/АТБ-RK3588J-SMC_1.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="images/home/ATB-RK3588J-SMC/АТБ-RK3588J-SMC_2.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="images/home/ATB-RK3588J-SMC/АТБ-RK3588J-SMC_3.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="images/home/ATB-RK3588J-SMC/АТБ-RK3588J-SMC_4.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                        <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                            <img class="hm-cat--img__SWIPER_SLIDE" src="images/home/ATB-RK3588J-SMC/АТБ-RK3588J-SMC_5.webp" alt="" loading="lazy">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="cd-rec--div__SWIPER_NAV">
                <button class="cd-rec--button__SWIPER_PREV swiper-button-disabled" disabled="" tabindex="-1" aria-label="Previous slide" aria-controls="swiper-wrapper-30d27127650a4060" aria-disabled="true">
                    <svg width="12" height="22" viewBox="0 0 12 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.2002 1.65002L10.0002 11L1.2002 20.35" stroke="#C82121" stroke-width="1.5" stroke-linecap="round"></path>
                    </svg>
                </button>
                <div class="cd-rec--div__SWIPER_NAV_LINE"></div>
                <button class="cd-rec--button__SWIPER_NEXT" tabindex="0" aria-label="Next slide" aria-controls="swiper-wrapper-30d27127650a4060" aria-disabled="false">
                    <svg width="12" height="22" viewBox="0 0 12 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.2002 1.65002L10.0002 11L1.2002 20.35" stroke="#C82121" stroke-width="1.5" stroke-linecap="round"></path>
                    </svg>
                </button>
