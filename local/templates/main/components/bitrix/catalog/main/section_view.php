...
<section class="hm-cat ct-cat ctn-cat">
            ...
            <div class="hm-cat--div__MAIN">
                <div class="hm-cat--div__LEFT ct-cat--div__LEFT">
                    <div class="ct-cat--div__FILTER_BACK">
                        <form id="ct-cat--form__FILTER" class="ct-cat--form__FILTER __C-SCRL DOWN" action="#"
                              method="post" name="ct-cat-filter">
                            ...
                            <div class="ct-cat--div__FILTER_BODY">
                                <div class="ct-cat--div__FILTER_ITEM">
                                    <button class="ct-cat--button__FILTER_ITEM_TOP" type="button">
                                        <div class="ct-cat--div__FILTER_ITEM_TOP">
                                            ...
                                            <svg class="ct-cat--svg__FILTER_ITEM_POPUP_OPEN" role="button" width="14"
                                            ...
                                            <div class="ct-cat--div__FILTER_ITEM_POPUP">
                                                ...
                                                <svg class="ct-cat--svg__FILTER_ITEM_POPUP_CLOSE" role="button"
                                        ...
                                        <svg class="ct-cat--svg__FILTER_ITEM_TOP" width="19" height="9"
                                             viewBox="0 0 19 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <fieldset class="ct-cat--fieldset__FILTER_ITEM_BODY">
                                        <label class="ct-cat--label__FILTER_ITEM">
                                            <input class="ct-cat--input__FILTER_ITEM" type="checkbox" name="ct-cat-1"
                                                   value="">
                                    ...
                                    <button class="ct-cat--button__FILTER_ITEM_ELSE _1" type="button">
                                        ...
                                        <svg class="ct-cat--svg__FILTER_ITEM_ELSE" width="11" height="6"
                                             viewBox="0 0 11 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0.125 0.125L5.125 4.83088L10.125 0.125" stroke="#0C0C0C"
                                                  stroke-width="0.25" stroke-linecap="round"/>
                                        </svg>
                                    </button>
                                    ...
                                    <button class="ct-cat--button__FILTER_ITEM_ELSE _2" type="button">
                                        ...
                                        <svg class="ct-cat--svg__FILTER_ITEM_ELSE" width="11" height="6"
                                             viewBox="0 0 11 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0.125 5L5.125 0.294117L10.125 5" stroke="#0C0C0C"
                                                  stroke-width="0.25" stroke-linecap="round"/>
                                        </svg>
                                    </button>
                                </div>
                                ...
                                <div class="ct-cat--div__FILTER_ITEM">
                                    <button class="ct-cat--button__FILTER_ITEM_TOP_R" type="button">
                                        ...
                                        <svg class="ct-cat--svg__FILTER_ITEM_TOP_R" width="19" height="9"
                                             viewBox="0 0 19 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0.125 0.125L9.125 8.59559L18.125 0.125" stroke="#0C0C0C"
                                                  stroke-width="0.25" stroke-linecap="round"/>
                                        </svg>
                ...
                <div class="ct-cat--div__CONTENT0">
                    <div class="ct-cat--div__BUTTONS __C-SCRL DOWN">
                        <div class="ct-cat--div__BUTTONS_LEFT">
                            <form class="ct-cat--form__SELECT" action="#" method="post" name="ct-cat-sort">
                                <button class="ct-cat--button__SELECT" type="button">
                                    <svg width="23" height="17" viewBox="0 0 23 17" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17.2501 16.6844L11.5 10.9344L11.9441 10.4903L16.9228 15.469V0.392578H17.5773V15.4456L22.556 10.4669L23.0001 10.9344L17.2501 16.6844Z"
                                              fill="#0C0C0C"/>
                                        <path d="M5.75007 0.00111198L0 5.75118L0.444111 6.19529L5.42283 1.21657V16.293H6.07731V1.23995L11.056 6.21866L11.5001 5.75118L5.75007 0.00111198Z"
                                              fill="#0C0C0C"/>
                                    </svg>
                                ...
                                <div class="ct-cat--div__SELECT">
                                    ...
                                    <label class="ct-cat--label__SELECT">
                                        По убыванию цены
                                        <input class="ct-cat--input__SELECT" type="radio" name="sort"
                                               value="price-down">
                                    </label>
                                    <label class="ct-cat--label__SELECT">
                                        По наличию
                            ...
                            <button class="ct-cat--button__FILTER_RESET" type="reset" form="ct-cat--form__FILTER">
                                <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0.391417 9.55059L0 9.15917L4.38388 4.77529L0 0.391417L0.391417 0L4.77529 4.38388L9.15917 0L9.55059 0.391417L5.16671 4.77529L9.55059 9.15917L9.15917 9.55059L4.77529 5.16671L0.391417 9.55059Z"
                                          fill="#0C0C0C"/>
                        ...
                        <div class="ct-cat--div__VIEWS">
                            ...
                            <button class="ct-cat--button__VIEWS _GRD">
                                <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M2 10.6083C0.89543 10.6083 0 9.7129 0 8.60833V2C0 0.89543 0.895431 0 2 0H8.60833C9.7129 0 10.6083 0.895431 10.6083 2V8.60833C10.6083 9.7129 9.7129 10.6083 8.60833 10.6083H2ZM2 24.3833C0.89543 24.3833 0 23.4879 0 22.3833V15.775C0 14.6704 0.895431 13.775 2 13.775H8.60833C9.7129 13.775 10.6083 14.6704 10.6083 15.775V22.3833C10.6083 23.4879 9.7129 24.3833 8.60833 24.3833H2ZM15.775 10.6083C14.6704 10.6083 13.775 9.7129 13.775 8.60833V2C13.775 0.89543 14.6704 0 15.775 0H22.3833C23.4879 0 24.3833 0.895431 24.3833 2V8.60833C24.3833 9.7129 23.4879 10.6083 22.3833 10.6083H15.775ZM15.775 24.3833C14.6704 24.3833 13.775 23.4879 13.775 22.3833V15.775C13.775 14.6704 14.6704 13.775 15.775 13.775H22.3833C23.4879 13.775 24.3833 14.6704 24.3833 15.775V22.3833C24.3833 23.4879 23.4879 24.3833 22.3833 24.3833H15.775ZM1.10833 8.5C1.10833 9.05229 1.55605 9.5 2.10833 9.5H8.5C9.05229 9.5 9.5 9.05229 9.5 8.5V2.10833C9.5 1.55605 9.05229 1.10833 8.5 1.10833H2.10833C1.55605 1.10833 1.10833 1.55605 1.10833 2.10833V8.5ZM14.8833 8.5C14.8833 9.05229 15.3311 9.5 15.8833 9.5H22.275C22.8273 9.5 23.275 9.05229 23.275 8.5V2.10833C23.275 1.55605 22.8273 1.10833 22.275 1.10833H15.8833C15.3311 1.10833 14.8833 1.55605 14.8833 2.10833V8.5ZM14.8833 22.275C14.8833 22.8273 15.3311 23.275 15.8833 23.275H22.275C22.8273 23.275 23.275 22.8273 23.275 22.275V15.8833C23.275 15.3311 22.8273 14.8833 22.275 14.8833H15.8833C15.3311 14.8833 14.8833 15.3311 14.8833 15.8833V22.275ZM1.10833 22.275C1.10833 22.8273 1.55605 23.275 2.10833 23.275H8.5C9.05229 23.275 9.5 22.8273 9.5 22.275V15.8833C9.5 15.3311 9.05229 14.8833 8.5 14.8833H2.10833C1.55605 14.8833 1.10833 15.3311 1.10833 15.8833V22.275Z"
                                          fill="#0C0C0C"/>
                                </svg>
                            </button>
                        </div>
                    </div>
                    <div class="ct-cat--div__CONTENT">
                        <article class="hm-cat--article__CARD __C-SCRL DOWN" href="#">
                            ...
                            <p class="hm-cat--p__CARD_TEXT">
                                ...
                                реестр российскиный рапавпвпаррор вашщшщестр
                                российск реестр российскиный рапавссийскиной,
                                вклюоный рер российскиный реестр российски
                            </p>
                                ...
                                <div class="hm-cat--div__SWIPER swiper">
                                    <div class="hm-cat--div__SWIPER_WRAPPER swiper-wrapper">
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-2100/АТБ-2100_1.webp" alt="" loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-2100/АТБ-2100_2.webp" alt="" loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-2100/АТБ-2100_3.webp" alt="" loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-2100/АТБ-2100_4.webp" alt="" loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-2100/АТБ-2100_5.webp" alt="" loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-2100/АТБ-2100_6.webp" alt="" loading="lazy">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_PAGINATION swiper-pagination"></div>
                                ...
                                <div class="hm-cat--div__SWIPER swiper">
                                    <div class="hm-cat--div__SWIPER_WRAPPER swiper-wrapper">
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-RK3568-MPC-G/АТБ-RK3568-MPC-G_1.webp" alt=""
                                                     loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-RK3568-MPC-G/АТБ-RK3568-MPC-G_2.webp" alt=""
                                                     loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-RK3568-MPC-G/АТБ-RK3568-MPC-G_3.webp" alt=""
                                                     loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-RK3568-MPC-G/АТБ-RK3568-MPC-G_4.webp" alt=""
                                                     loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-RK3568-MPC-G/АТБ-RK3568-MPC-G_5.webp" alt=""
                                                     loading="lazy">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="hm-cat--div__SWIPER swiper">
                                    <div class="hm-cat--div__SWIPER_WRAPPER swiper-wrapper">
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-2400/АТБ-2400_1.webp" alt="" loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-2400/АТБ-2400_2.webp" alt="" loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-2400/АТБ-2400_3.webp" alt="" loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-2400/АТБ-2400_4.webp" alt="" loading="lazy">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="hm-cat--div__SWIPER_PAGINATION swiper-pagination"></div>
                                ...
                                <div class="hm-cat--div__SWIPER swiper">
                                    <div class="hm-cat--div__SWIPER_WRAPPER swiper-wrapper">
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-RK3568-MPC-M/АТБ-RK3568-MPC-M_1.webp" alt=""
                                                     loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-RK3568-MPC-M/АТБ-RK3568-MPC-M_2.webp" alt=""
                                                     loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-RK3568-MPC-M/АТБ-RK3568-MPC-M_3.webp" alt=""
                                                     loading="lazy">
                                            </div>
                                        </div>
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-RK3568-MPC-M/АТБ-RK3568-MPC-M_4.webp" alt=""
                                                     loading="lazy">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="hm-cat--div__SWIPER swiper">
                                    <div class="hm-cat--div__SWIPER_WRAPPER swiper-wrapper">
                                        ...
                                        <div class="hm-cat--div__SWIPER_SLIDE swiper-slide">
                                            <div class="hm-cat--div__SWIPER_SLIDE_CONT">
                                                <img class="hm-cat--img__SWIPER_SLIDE"
                                                     src="images/home/ATB-RK3588J-SMC/АТБ-RK3588J-SMC_5.webp"
