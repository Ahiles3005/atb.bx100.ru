...
<section class="cd-hero">
    <div class="cd-hero--div__CONT C-CONTAINER">
        ...
        $elementResult = CIBlockElement::GetByID($elementResult['ID'])->GetNextElement(false, false, true);  // $elementId — ID элемента

        if ($elementResult) {
            $arFields = $elementResult->GetFields();
            $arProps = $elementResult->GetProperties();  // Все свойства здесь!
        }
