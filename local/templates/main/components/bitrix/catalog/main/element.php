...
<section class="cd-hero">
    <div class="cd-hero--div__CONT C-CONTAINER">
        ...
        <?
        $elementResult = $APPLICATION->IncludeComponent(
                'bitrix:news.detail',
                'clear',
                $componentElementParams,
                $component,
        ...
        $element = CIBlockElement::GetByID($elementResult['ID'])->GetNextElement(true, true, true);  // $elementId — ID элемента
        ...
        //        echo '<pre>';
        //        var_dump($arProps['SCHEMES']);
        //        var_dump($arProps['MATERIALS']);
        //        var_dump($arProps['REGISTRY']);
        //        var_dump($arProps);
        //        echo '</pre>';
        ...
        $schemesData = getSchemesData($arProps['SCHEMES'] ?? []);
        $materialsaData = getMaterialsData($arProps['MATERIALS'] ?? []);
        $registryData = getRegistryData($arProps['REGISTRY'] ?? []);


        //                echo '<pre>';
        //                var_dump($schemesData);
        //                var_dump($materialsaData);
        //                var_dump($registryData);
        //
        //                echo '</pre>';
        ?>
            ...
            <div class="cd-hero--div__LEFT">
                <div class="cd-hero--div__LEFT_CONT">
                    <div class="cd-hero--div__TOP">
                        ...
                        <div class="cdn-hero--div__CARD_PRICE __C-SCRL DOWN">
                            <p class="cdn-hero--p__CARD_PRICE_CUR">
                                <span class="cdn-hero--span__CARD_PRICE_CUR"><?= $arProps['PRICE_NEW']['VALUE'] ?? '' ?></span>
                                <sup>*</sup>
                            ...
                            <p class="cdn-hero--p__CARD_PRICE_OLD">
                                <span class="cdn-hero--span__CARD_PRICE_OLD"><?= $arProps['PRICE_OLD']['VALUE'] ?? '' ?></span>
                    ...
                    <div class="cdn-hero--div__DESCR">
                        ...
                        <a class="cdn-hero--a__NAME __C-SCRL DOWN" href="<?= $elementResult['SECTION_URL'] ?>">
                            <?= $elementResult['SECTION']['PATH'][count($elementResult['SECTION']['PATH']) - 1]['NAME'] ?>
                        </a>
                        <a class="cdn-hero--a__TO_SERIES __C-SCRL DOWN" href="<?= $elementResult['SECTION_URL'] ?>">
                            ПЕРЕЙТИ В СЕРИЮ
                        </a>
                    </div>
        ...
        <div class="cd-abt--div__SWIPER2 swiper __C-SCRL DOWN">
            <div class="cd-abt--div__SWIPER2_WRAPPER swiper-wrapper">
                ...
                <div class="cd-abt--div__SWIPER2_SLIDE swiper-slide">
                    ...
                    <?= $arProps['SOVMESTIMOE_PO']['~VALUE']['TEXT'] ?? '' ?>
                </div>
            </div>
        </div>
...
<section class="cd-reg">
    <div class="cd-reg--div__CONT C-CONTAINER">
        ...
        <div class="cd-reg--div__TABLE __C-SCRL DOWN">
            ...
            <? foreach ($registryData as $registry): ?>
