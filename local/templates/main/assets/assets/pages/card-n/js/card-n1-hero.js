...
window.addEventListener ("load", function () {
    ...
    if (document.querySelector ("#card-n")) {
        ...
        function cdnHeroPriceSplit () {
            const localFormat = new Intl.NumberFormat("ru-RU");

            const cdnHeroPrices = Array.from (document.querySelectorAll (".cdn-hero--span__CARD_PRICE_CUR:first-of-type, .cdn-hero--span__CARD_PRICE_OLD:first-of-type"));
            cdnHeroPrices.forEach ((v, i, a) => {
