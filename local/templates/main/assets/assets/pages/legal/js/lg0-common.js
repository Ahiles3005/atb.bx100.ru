...
window.addEventListener ("load", function () {
    ...
    if (document.querySelector ("#lg1") || document.querySelector ("#lg2") || document.querySelector ("#lg3") || document.querySelector ("#lg4") || document.querySelector ("#lg5") || document.querySelector ("#lg6"))  {
