...
window.addEventListener ("load", function () {
    ...
    if (document.querySelector ("#srv1")) {
        ...
        // 2. ВТОРОЙ ТИП КОНТЕНТА - ФОТОГАЛЕРЕЯ И ВИДЕОГАЛЕРЕЯ
        ...
        // 2.2 Копирование изображений в кнопки пагинации 
        ...
        // 2.4 Если картинок больше 1, включить превью
