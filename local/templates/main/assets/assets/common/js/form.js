...
window.addEventListener ("load", function () {
    ...
    if (document.querySelector ("#conts .conts-main--div__FORM")) {
        document.querySelector (".conts-main--div__FORM").insertAdjacentHTML ("beforeend", `
        ...
        const cCommonDivFbComm = document.querySelector (".conts-main--div__FORM");
